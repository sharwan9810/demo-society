...
if(isset($_GET['lan'])){
    ...
    $query = "SELECT * from loans where lan = $lan";
...
if(isset($_POST['assignaccount'])){
    // if(isset($_GET['aadharnumber_updated'])){
    //     $aadharcardnew = $_GET['aadharnumberupdated'];
    // }
    ...
    `loanstatus` = '$loanstatus', `ldcr` = '$ldcr',`method` = '$method' where lan = '$lan'";
...
?>
 <form action="loanfurtherprocess.php" method="POST">
        <table>
        ...
        <td><input type="text" class="form-control" readonly name="fname" value="<?php echo $row['fname'];?>"></td>
        </tr>
        </div>
        <tr>
        <div class="feild">
        ...
        <td><input type="text" class="form-control" readonly name="lan" value="<?php echo $row['lan'];?>"></td>
        </tr> 
        <tr>
        <div class="feild">
        <td><label for="accountnumber">
            Account Number
        </label></td>
        <td><input type="text" class="form-control" readonly name="accountno" value="<?php echo $row['accountno'];?>"></td>
        </tr>    
    </div>
        <tr>
        <div class="feild">
        <td><label for="LOAN STATUS UPDATE">
            Loan Status
        </label></td>
        <td>
        ...
        <td><input type="text" class="form-control" name="amount" readonly value="<?php echo $row['amount'];?>"></td>
        </div>
        <div class="feild">
        <tr>
            <td><label for="ldcr">Amount Sanctioned</label></td>
            <td><input type="number" class="form-control" name="ldcr"></td>
        </tr>
        </div>
        <tr>
            <td><label for="method">Payment Made Through</label></td>
            <td><select name="method" id="" class="form-select">
        ...
        <td><input type="hidden" name="aadharnumber" value="<?php echo $row['aadharnumber'] ?>"></td>
        <td><input type="hidden" name="transactionno" value="<?php echo(rand(913258741,999999999)); ?>"></td>
        <td><input type="hidden" name="phonenumber" value="<?php echo $row['phonenumber'] ;?>"></td>
        
</table>
<input type="submit" class="btn btn-primary" href="dashboard.php" name="assignaccount" value="Process Application" id="assigned">
<button class="btn btn-secondary"><a href="dashboard.php">Dashboard</a></button>
<?php
error_reporting(E_ERROR | E_PARSE);
        ...
        $sql = "INSERT INTO `newloan`(`accountno`, `fname`, `aadharnumber`, `phonenumber`, `transactionno`,  `ldcr`) VALUES ('$accountno','$fname','$aadharnumber','$phonenumber','$transactionno','$ldcr')";
        $result = mysqli_query($conn, $sql);
        if(!$result){
            die('Query Failed'.mysqli_error());
        }else{
            echo "<SCRIPT>alert('Loan Processed Successfully')</SCRIPT>";
