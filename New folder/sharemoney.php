<?php 
    ...
    require_once("connectionenrollment.php");
    $query = " SELECT * from newloan where sharemoney = '500'";
...
<div class="container">
    <h2>Share Money Holders</h2>
    <div class="row">
                <div class="col m-auto">
                    <div class="card mt-5">
                        <table class="table table-striped" border="1" cellspacing="5">
                            <tr>
                            ...
                            <?php 
                                    ...
                                    {
                                        $UserID = $row['accountno'];
                                        $UserName = $row['fname'];
                                        $UserAad = $row['aadharnumber'];
                                        $UserAge = $row['phonenumber'];
                                        $sharemoney = $row['sharemoney'];
                            ?>
                                    <tr>
                                        <td><?php echo $UserID ?></td>
                                        <td><?php echo $UserName ?></td>
                                        <td><?php echo $UserAad ?></td>
                                        <td><?php echo $UserAge ?></td>
                                        <td><?php echo $sharemoney?></td>
                                    </tr>        
                            <?php 
                                    }  
                            ?>                                                                    
