...
?>">
                ...
                <table class="into">
                       <th>Share Money</th>
                       <td><input type="number" class="form-control" name="sharemoney"></td>
                       <th>Compluslory Deposit</th>
                       <td><input type="number" class="form-control" name="cdcr"></td><br>
                       <th>Optional Deposit</th>
                       <td><input type="number" class="form-control" name="odcr"></td><th>Loan Deposit</th>
                       <td><input type="number" class="form-control" name="lddr"></td>
