...
<div class="container">
    <h2>Upload Photo and Signature of Member</h2>
    <form action="upload.php" method="post" enctype="multipart/form-data">
    <label for="application_number">Application Number:</label><br>
    <input type="number" class="form-control" name="token" required><br>

    <label for="photo">Upload Photo:</label><br>
    <input type="file" class="form-control" name="photo" accept="image/*" required><br>

    <label for="signature">Upload Signature:</label><br>
    <input type="file" class="form-control" name="signature" accept="image/*" required><br>
