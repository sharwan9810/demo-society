    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($result) {
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<h1>Account Opening Form</h1>";
...
<table class="table table-striped">
        ...
        <tr>
            ...
            <td><?php echo $row['spouse'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>correspondence Address</td>
            <td><?php echo $row['caddress'] . "<br>" ?></td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Occupation</td>
            <td><?php echo $row['occupation'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Religion</td>
            <td><?php echo $row['religion'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Annual Income</td>
            <td><?php echo $row['annualincome'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Property Status</td>
            <td><?php echo $row['propertystatus'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Social Category</td>
            <td><?php echo $row['caste'] . "<br>" ?></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
    ...
    <table class="table table-striped" id="data">
        ...
        <tr>
            ...
            <td><?php echo $row['alternatephone'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Email ID</td>
    ...
    <table class="table table-striped" id="data">
        <thead>Nominee Details</thead>
        <tr>
            <td>Nominee Name</td>
            <td><?php echo $row['nomineename'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Nominee Age</td>
            <td><?php echo $row['nomineeage'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Nominee Gender</td>
            <td><?php echo $row['nomineegender'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Nominee Relation</td>
            <td><?php echo $row['nomineerelation'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Nominee Address</td>
            <td><?php echo $row['nomineeadress'] . "<br>" ?></td>
        </tr>
        <tr>
            <td>Guardian Details(If Minor)</td>
            <td><?php echo $row['guardianinminor'] . "<br>" ?></td>
        </tr>
        <tr>
            <td></td>
            <td></td>
...
<div class="para">
    <p>I <?php echo $row['fname']  ?> <?php echo $row['lname'] ?> hereby declare that the above facts are true to the best of my knowledge and belief
        and I understand that I subject myself to disciplinary action in the event that
        the above facts are found to be falsified. </p>
</div>
<div class="buttons">
