...
<div class="container">
    ...
    <div class="deposit">
        ...
        <form action="newwithdrawalconfirm.php" method="post">
            ...
            <td><input type="text" class="form-control" name="aadharnumber" readonly  value="<?php echo "$row[aadharnumber]"?>"><br></td>
                ...
                Mobile Number:
                    ...
                    <input class="form-control" type="hidden" name="transactionno" value="<?php
...
?>">
                ...
                <input type="hidden" name="cdcr">
                <input type="hidden" name="sharemoney">
                <input type="hidden" name="ldcr">
                <input type="hidden" name="odcr">


                       <th>CD Withdrawal</th>
                       <td><input type="number" class="form-control" name="cddr" required></td>
                       <th>OD Withdrawal</th>
                       <td><input type="number" class="form-control" name="oddr" required></td>
                       <!-- <th>Loan Deposit</th> -->
                       <td><input type="hidden" name="lddr"></td>
                </table>
                </tr>
                <tr>
                    <td><button name="submit" class="btn btn-success">Withdrawal</button></td>
