...
<div class="container">
    <h2>Withdrawal Membership</h2>
    <form action="withdrawalmembership.php" method="post">
        <input type="text" name="accountno" class="form-control">
        <input type="submit" name="fetch" class="btn btn-primary">
        <?php
    ...
    <form action="withdrawalmembership.php">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" readonly value="<?php echo $row['accountno'] ?>" name="accountno"></td>
        </tr>
        <tr>
            <td>Aadhar Number:</td>
            <td><input type="text" readonly class="form-control" name="aadharnumber" value="<?php echo $row['aadharnumber'] ?>"></td>
        </tr>
        <tr>
            <td>PAN Number:</td>
        ...
        <tr>
            ...
            <td><select class="form-select">
                ...
                <option value="Supernnuation">Supernnuation</option>
                <option value="Others">Others</option>
            </select></td>
        </tr>
        <tr>
            <td><input type="checkbox" required>
            <td>I am aware that it is non reversible process and once withdrawn data cannot be reverted.</td>
            </td>
        </tr>
        <tr>
            <td><input type="submit" name="submit" value="Withdrawal Membership" class="btn btn-danger"></td>
        </tr>
        <?php
...
$sql = "DELETE FROM basicdata WHERE accountno=$accountno AND aadharnumber = $aadharnumber";
